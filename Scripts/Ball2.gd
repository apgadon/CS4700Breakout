...
func reset():
	speed = 400
	set_position(Vector2(get_node("/root/SceneNode/BottomBar/Mid").position.x, 553.187))
...
#			print("Collided with: ", collision.collider.name)
			...
			if (collision.collider.name == "Wall" || collision.collider.name == "Wall2" || collision.collider.name == "Wall3"):
				$Wall.play()
			if (collision.collider.name == "Floor" || collision.collider.name == "Wall" || collision.collider.name == "Wall2" || collision.collider.name == "Wall3"):
				xSpeed = 0
				ySpeed = 0
				$Lose.play()
				lives -= 1
			...
			if (collision.collider.name == "LMid" || collision.collider.name == "LMid2"):
				...
				$Bar.play()
				xSpeed = 0
			elif (collision.collider.name == "LMid3" || collision.collider.name == "LMid4"):
				$Bar.play()
				ySpeed = -100 * mul
			elif (collision.collider.name == "RMid3" || collision.collider.name == "RMid4"):
				$Bar.play()
				ySpeed = 100 * mul
			elif (collision.collider.name == "LLMid3" || collision.collider.name == "LLMid4"):
				$Bar.play()
				ySpeed = -200 * mul
			elif (collision.collider.name == "RRMid3" || collision.collider.name == "RRMid4"):
				$Bar.play()
				ySpeed = 200 * mul
			elif (collision.collider.name == "LLLMid3" || collision.collider.name == "LLLMid4"):
				$Bar.play()
				ySpeed = -300 * mul
			elif (collision.collider.name == "RRRMid3" || collision.collider.name == "RRRMid4"):
				$Bar.play()
				ySpeed = 300 * mul
			elif (collision.collider.name == "LLLLMid3" || collision.collider.name == "LLLLMid4"):
				$Bar.play()
				ySpeed = -400 * mul
			elif (collision.collider.name == "RRRRMid3" || collision.collider.name == "RRRRMid4"):
				$Bar.play()
				ySpeed = 400 * mul
			elif (collision.collider.name == "Left3" || collision.collider.name == "Left4"):
				$Bar.play()
				ySpeed = -500 * mul
			elif (collision.collider.name == "Right3" || collision.collider.name == "Right4"):
				$Bar.play()
				ySpeed = 500 * mul
			elif (collision.collider.name == "Mid3" || collision.collider.name == "Mid4"):
				$Bar.play()
				ySpeed = 0
		if is_on_wall():
			xSpeed *= -1
